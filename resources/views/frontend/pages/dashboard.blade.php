...
@push('plugin-styles')
  <link href="{{ asset('frontend/assets/plugins/bootstrap-datepicker/css/bootstrap-datepicker.min.css') }}" rel="stylesheet" />
@endpush
...
@push('plugin-scripts')
  <script src="{{ asset('frontend/assets/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js') }}"></script>
  <script src="{{ asset('frontend/assets/plugins/apexcharts/apexcharts.min.js') }}"></script>
@endpush
