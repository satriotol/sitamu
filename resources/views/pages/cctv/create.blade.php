    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div>
                ...
                <form class="w-full" action="@isset($cctv) {{route('cctv.update', $cctv->id)}} @endisset @empty($cctv) {{route('cctv.store')}}
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input value="{{isset($cctv) ? $cctv->url : old('url')}}" name="url" required
                                class="form-control"
                                id="grid-last-name" type="text" placeholder="URL">
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
